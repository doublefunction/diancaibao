...
<body>
    ...
    <div class="side-bar">
        <div class="content">
            <dl>
                ...
                <dd>
                    <a href="#user/show">用户列表  <i class="lo">12</i> </a>
            ...
            <dl>
                ...
                <dd>
                    <a href="#view/shopList.html">商户列表 </a>
    ...
    <div id="main" >
        <div   style="-webkit-overflow-scrolling:touch;overflow:auto;height: 100%;">
            <iframe class="scroll" src="view/main.jsp" id="ghrzFrame" frameborder="no" border="0"></iframe>
        </div>
    </div>
</body>
